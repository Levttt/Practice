...
$db = [
        [
                'header1' => 'Privacy', 'info1' => 'Your privacy is important to us at SmartAdmin and the protection, confidentiality and integrity of your personal data are our prime concerns.
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        ...
                        <h2><?php echo $val['header1']; ?></h2>
                        <p class="mb-g">
                            <?php echo $val['info1']; ?>
                        </p>
                        <h3> <?php echo $val['header2']; ?> </h3>
                        <p>
                            <?php echo $val['info2']; ?>
                        </p>
                        <?php endforeach; ?>
