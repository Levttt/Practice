<?php
$privacyInfo = '<h2>Privacy</h2>';
$privacyInfoDescription = '<p class="mb-g">
...
$coociesInfo = '<h3>Cookies and other similar technologies</h3>';
$coociesInfoDescription = 'p>
...
$info = array($privacyInfo, $privacyInfoDescription, $coociesInfo, $coociesInfoDescription);
?>
